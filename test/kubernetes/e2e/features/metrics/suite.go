	...
	s.TestInstallation.Assertions.AssertEventualCurlResponse(
		...
		&testmatchers.HttpResponse{
			...
			Body: gomega.And(
				...
				gomega.MatchRegexp(`kgateway_resources_xds_snapshot_syncs_started_total\{gateway=\"gw1\",namespace=\"default\"} 1`),
				gomega.MatchRegexp(`kgateway_resources_xds_snapshot_syncs_started_total\{gateway=\"gw2\",namespace=\"default\"} 1`),
				gomega.MatchRegexp(`kgateway_resources_xds_snapshot_syncs_completed_total\{gateway=\"gw1\",namespace=\"default\",resource=\"Gateway\"} 1`),
				gomega.MatchRegexp(`kgateway_resources_xds_snapshot_syncs_completed_total\{gateway=\"gw2\",namespace=\"default\",resource=\"Gateway\"} 1`),
				gomega.MatchRegexp(`kgateway_resources_xds_snapshot_syncs_completed_total\{gateway=\"gw2\",namespace=\"default\",resource=\"HTTPRoute\"} 1`),
