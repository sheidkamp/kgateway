	...
	s.TestInstallation.Assertions.AssertEventualCurlResponse(
		...
		&testmatchers.HttpResponse{
			...
			Body: gomega.And(
				...
				gomega.MatchRegexp(`kgateway_resources_syncs_started_total\{gateway=\"gw1\",namespace=\"default\",resource=\"Gateway\"} 9`),
				gomega.MatchRegexp(`kgateway_resources_syncs_started_total\{gateway=\"gw2\",namespace=\"default\",resource=\"Gateway\"} 5`),
				gomega.MatchRegexp(`kgateway_resources_syncs_started_total\{gateway=\"gw2\",namespace=\"default\",resource=\"HTTPRoute\"} 6`),
				gomega.MatchRegexp(`kgateway_resources_status_syncs_completed_total\{gateway=\"gw1\",namespace=\"default\",resource=\"Gateway\"} 9`),
				gomega.MatchRegexp(`kgateway_resources_status_syncs_completed_total\{gateway=\"gw2\",namespace=\"default\",resource=\"Gateway\"} 5`),
				gomega.MatchRegexp(`kgateway_resources_status_syncs_completed_total\{gateway=\"gw2\",namespace=\"default\",resource=\"HTTPRoute\"} 6`),
				gomega.MatchRegexp(`kgateway_resources_status_sync_duration_seconds_count\{gateway=\"gw1\",namespace=\"default\",resource=\"Gateway\"} 9`),
				gomega.MatchRegexp(`kgateway_resources_status_sync_duration_seconds_count\{gateway=\"gw2\",namespace=\"default\",resource=\"Gateway\"} 5`),
				gomega.MatchRegexp(`kgateway_resources_status_sync_duration_seconds_count\{gateway=\"gw2\",namespace=\"default\",resource=\"HTTPRoute\"} 6`),
				gomega.MatchRegexp(`kgateway_resources_xds_snapshot_syncs_completed_total\{gateway=\"gw1\",namespace=\"default\",resource=\"Gateway\"} 9`),
				gomega.MatchRegexp(`kgateway_resources_xds_snapshot_syncs_completed_total\{gateway=\"gw2\",namespace=\"default\",resource=\"Gateway\"} 5`),
				gomega.MatchRegexp(`kgateway_resources_xds_snapshot_syncs_completed_total\{gateway=\"gw2\",namespace=\"default\",resource=\"HTTPRoute\"} 6`),
				gomega.MatchRegexp(`kgateway_resources_xds_snapshot_sync_duration_seconds_count\{gateway=\"gw1\",namespace=\"default\",resource=\"Gateway\"} 9`),
				gomega.MatchRegexp(`kgateway_resources_xds_snapshot_sync_duration_seconds_count\{gateway=\"gw2\",namespace=\"default\",resource=\"Gateway\"} 5`),
				gomega.MatchRegexp(`kgateway_resources_xds_snapshot_sync_duration_seconds_count\{gateway=\"gw2\",namespace=\"default\",resource=\"HTTPRoute\"} 6`),
				...
				gomega.MatchRegexp(`kgateway_xds_snapshot_resources\{gateway=\"gw1\",namespace=\"default\",resource=\"Endpoint\"} 12`),
				gomega.MatchRegexp(`kgateway_xds_snapshot_resources\{gateway=\"gw1\",namespace=\"default\",resource=\"Route\"} 3`),
				gomega.MatchRegexp(`kgateway_xds_snapshot_resources\{gateway=\"gw2\",namespace=\"default\",resource=\"Endpoint\"} 12`),
