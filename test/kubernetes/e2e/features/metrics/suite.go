	...
	s.TestInstallation.Assertions.AssertEventualCurlResponse(
		...
		&testmatchers.HttpResponse{
			...
			Body: gomega.And(
				...
				gomega.MatchRegexp(`kgateway_xds_snapshot_syncs_total\{gateway=\"gw1\",namespace=\"default\"} 1`),
				gomega.MatchRegexp(`kgateway_xds_snapshot_syncs_total\{gateway=\"gw2\",namespace=\"default\"} 1`),
