...
Metrics which currently exist and do not conform the naming convention will be left in place until the next major version and a parallel metric will be created with a conforming name.
