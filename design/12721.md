...
* XListenerSet - Introduced in v1.3.0 experimental. Not available in standard.
* BackendTLSPolicy - v1 was introduced in v1.4.0 for both experimental and standard. The v1alpha3 version previously used in the experimental channel is not supported
* TCPRoute - Added to experimental in v0.3.0, not in available in standard
* CORS filters - v1.3 experimental
* HTTPRoutes.spec.rules[].name - in experimental v1.2.0 and standard v1.3.0
