...
func (k *kGatewayParameters) getGatewayParametersForGatewayClass(ctx context.Context, gwc *api.GatewayClass) (*v1alpha1.GatewayParameters, error) {
	...
	defaultGwp := k.getInMemoryGatewayParameters(gwc.Name)
...
func (k *kGatewayParameters) getInMemoryGatewayParameters(name string) *v1alpha1.GatewayParameters {
	...
	case wellknown.WaypointClassName:
		return k.defaultWaypointGatewayParameters()
	case wellknown.GatewayClassName:
		return k.defaultGatewayParameters()
	case wellknown.AgentGatewayClassName:
		return k.defaultAgentGatewayParameters()
	default:
		return k.defaultGatewayParameters()
	}
}
...
func (k *kGatewayParameters) defaultAgentGatewayParameters() *v1alpha1.GatewayParameters {
	gwp := k.defaultGatewayParameters()
...
func (k *kGatewayParameters) defaultWaypointGatewayParameters() *v1alpha1.GatewayParameters {
	gwp := k.defaultGatewayParameters()
...
// set for the gateway.
func (k *kGatewayParameters) defaultGatewayParameters() *v1alpha1.GatewayParameters {
	gwp := &v1alpha1.GatewayParameters{
			...
			Kube: &v1alpha1.KubernetesProxyConfig{
				...
				EnvoyContainer: &v1alpha1.EnvoyContainer{
					...
					Image: &v1alpha1.Image{
						Registry:   ptr.To(k.inputs.ImageInfo.Registry),
						Tag:        ptr.To(k.inputs.ImageInfo.Tag),
						Repository: ptr.To(EnvoyWrapperImage),
						PullPolicy: (*corev1.PullPolicy)(ptr.To(k.inputs.ImageInfo.PullPolicy)),
					},
