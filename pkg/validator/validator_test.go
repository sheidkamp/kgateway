...
func TestExtractEnvoyError(t *testing.T) {
  ...
  validation context: http_connection_manager`,
		...
		},
		{
			...
			input: `Unable to find image 'quay.io/solo-io/envoy-gloo:1.36.7-patch1' locally
1.36.7-patch1: Pulling from solo-io/envoy-gloo
...
Status: Downloaded newer image for quay.io/solo-io/envoy-gloo:1.36.7-patch1
